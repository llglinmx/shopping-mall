<template>
	<view class="no-data flex-center">
		<view class="flex-direction flex-center" style="transform: translateY(-120rpx);">
			<image :src="imageUrl" mode="aspectFill" style="width: 200rpx;height: 200rpx;"></image>
			<text class="font-24" style="color: #999;">{{msg}}</text>
		</view>
	</view>
</template>
